...
{
    public function ctrIngresoUser()
    {
        ...
        if (isset($_POST["ingEmail"])) {
            ...
            if (
                ...
                $respuesta = ModeloAdmin::mdlMostrarUsersAdmin($tabla, $item, $valor);
    ...
    static public function ctrCrearPerfil()
    {
        ...
        if (isset($_POST["nuevoPerfil"])) {
            ...
            if (
                ...
                $respuesta = ModeloAdmin::mdlIngresarPerfil($tabla, $datos);
    ...
    static public function ctrEditarPerfil()
    {
        ...
        if (isset($_POST["idPerfil"])) {
            ...
            if (preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["editarNombre"])) {
                ...
                $respuesta = ModeloAdmin::mdlEditarPerfil($tabla, $datos);
    ...
    static public function ctrEliminarPerfil()
    {
        ...
        if (isset($_GET["idPerfil"])) {
            ...
            $respuesta = ModeloAdmin::mdlEliminarPerfil($tabla, $datos);
