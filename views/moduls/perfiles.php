      ...
      <div class="box-body">
        ...
        <table class="table table-bordered table-striped dt-responsive tablaPerfiles" width="100%">
          ...
          <tbody>
            ...
            $perfiles = ControladorAdmin::ctrMostrarAdministradores($item, $valor);
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        $crearPerfil = new ControladorAdmin();
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        $editarPerfil = new ControladorAdmin();
...
$eliminarPerfil = new ControladorAdmin();
